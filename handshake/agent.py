...
class Agent:
  ...
  def __init__(self, identify: str, key_service: KeyService, no_of_one_time_keys: int):
    ...
    self.user_key_bundle = UserKeyBundle(no_of_one_time_keys)
    self.key_service = key_service
    self.key_service.create_user(identify, PublicKeyBundle(self.user_key_bundle))
    self.connections = {}
  ...
  def initial_message(self, user_id: str, initial_message_bundle: InitialMessageBundle):
    ...
    SPKb = PublicKeyBundle(self.user_key_bundle).signed_identity_key
